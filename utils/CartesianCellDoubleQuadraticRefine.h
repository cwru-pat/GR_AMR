 ...
 *
 ************************************************************************/
#ifndef included_geom_CartesianCellDoubleQuadraticRefine
#define included_geom_CartesianCellDoubleQuadraticRefine
...
class CartesianCellDoubleQuadraticRefine:
...
public:
    ...
    */
   CartesianCellDoubleQuadraticRefine();

   /**
    * Uninteresting virtual destructor.
    */
   virtual ~CartesianCellDoubleQuadraticRefine();
