 ...
 *
 ************************************************************************/
#ifndef included_geom_CartesianCellDoubleHermiteRefine
#define included_geom_CartesianCellDoubleHermiteRefine
...
class CartesianCellDoubleHermiteRefine:
...
public:
    ...
    */
   CartesianCellDoubleHermiteRefine();

   /**
    * Uninteresting virtual destructor.
    */
   virtual ~CartesianCellDoubleHermiteRefine();
