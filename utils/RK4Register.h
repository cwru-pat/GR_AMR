...
class RK4Register
{
  ...
  public:
    ...
    void init(IT nx_in, IT ny_in, IT nz_in, RT sim_dt_in)
    {
      ...
      points = (nx_in + bd_nx)*(ny_in+bd_ny)*(nz_in+bd_nz);
      _array_p.init(nx_in+bd_nx, ny_in+bd_ny, nz_in+bd_nz);
      _array_a.init(nx_in+bd_nx, ny_in+bd_ny, nz_in+bd_nz);
      _array_c.init(nx_in+bd_nx, ny_in+bd_ny, nz_in+bd_nz);
      _array_f.init(nx_in+bd_nx, ny_in+bd_ny, nz_in+bd_nz);
    }
