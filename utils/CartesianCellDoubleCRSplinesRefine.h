 ...
 *
 ************************************************************************/
#ifndef included_geom_CartesianCellDoubleCRSplinesRefine
#define included_geom_CartesianCellDoubleCRSplinesRefine
...
class CartesianCellDoubleCRSplinesRefine:
...
public:
    ...
    */
   CartesianCellDoubleCRSplinesRefine();

   /**
    * Uninteresting virtual destructor.
    */
   virtual ~CartesianCellDoubleCRSplinesRefine();
