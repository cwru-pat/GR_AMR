...
#ifndef included_geom_CartesianCellDoubleCRSplinesCoarsen
#define included_geom_CartesianCellDoubleCRSplinesCoarsen
...
class CartesianCellDoubleCRSplinesCoarsen:
...
public:
    ...
    */
   CartesianCellDoubleCRSplinesCoarsen();

   /**
    * Uninteresting virtual destructor.
    */
   virtual ~CartesianCellDoubleCRSplinesCoarsen();

   double evaluateInterpolation(
     double * a, double x, double y, double z) const;
