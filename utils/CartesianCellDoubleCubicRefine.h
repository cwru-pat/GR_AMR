 ...
 *
 ************************************************************************/
#ifndef included_geom_CartesianCellDoubleCubicsRefine
#define included_geom_CartesianCellDoubleCubicsRefine
...
class CartesianCellDoubleCubicRefine:
...
public:
    ...
    */
   CartesianCellDoubleCubicRefine();

   /**
    * Uninteresting virtual destructor.
    */
   virtual ~CartesianCellDoubleCubicRefine();
