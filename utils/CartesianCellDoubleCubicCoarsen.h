...
#ifndef included_geom_CartesianCellDoubleCubicCoarsen
#define included_geom_CartesianCellDoubleCubicCoarsen
...
class CartesianCellDoubleCubicCoarsen:
...
public:
    ...
    */
   CartesianCellDoubleCubicCoarsen();

   /**
    * Uninteresting virtual destructor.
    */
   virtual ~CartesianCellDoubleCubicCoarsen();

   double CINT(double u, double p0, double p1, double p2, double p3) const;
