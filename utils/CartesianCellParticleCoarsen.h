...
#ifndef included_geom_CartesianCellParticleCoarsen
#define included_geom_CartesianCellParticleCoarsen

#include "SAMRAI/SAMRAI_config.h"


#include "../components/geodesic/particles.h"
...
class CartesianCellParticleCoarsen:
...
public:
    ...
    */
   CartesianCellParticleCoarsen();

   /**
    * Uninteresting virtual destructor.
    */
   virtual ~CartesianCellParticleCoarsen();
