...
#ifndef included_geom_CartesianCellDoubleHermiteCoarsen
#define included_geom_CartesianCellDoubleHermiteCoarsen
...
class CartesianCellDoubleHermiteCoarsen:
...
public:
    ...
    */
   CartesianCellDoubleHermiteCoarsen();

   /**
    * Uninteresting virtual destructor.
    */
   virtual ~CartesianCellDoubleHermiteCoarsen();
