...
#ifndef included_geom_CartesianCellDoubleLinearCoarsen
#define included_geom_CartesianCellDoubleLinearCoarsen
...
class CartesianCellDoubleLinearCoarsen:
...
public:
    ...
    */
   CartesianCellDoubleLinearCoarsen();

   /**
    * Uninteresting virtual destructor.
    */
   virtual ~CartesianCellDoubleLinearCoarsen();
