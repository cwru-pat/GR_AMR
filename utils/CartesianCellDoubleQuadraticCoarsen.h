...
#ifndef included_geom_CartesianCellDoubleQuadraticCoarsen
#define included_geom_CartesianCellDoubleQuadraticCoarsen
...
class CartesianCellDoubleQuadraticCoarsen:
...
public:
    ...
    */
   CartesianCellDoubleQuadraticCoarsen();

   /**
    * Uninteresting virtual destructor.
    */
   virtual ~CartesianCellDoubleQuadraticCoarsen();
