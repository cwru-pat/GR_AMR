 ...
 *
 ************************************************************************/
#ifndef included_geom_CartesianCellParticleRefine
#define included_geom_CartesianCellParticleRefine
...
class CartesianCellParticleRefine:
...
public:
    ...
    */
   CartesianCellParticleRefine();

   /**
    * Uninteresting virtual destructor.
    */
   virtual ~CartesianCellParticleRefine();
