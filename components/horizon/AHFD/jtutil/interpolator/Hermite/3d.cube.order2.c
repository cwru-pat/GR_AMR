...
#define COEFFS_I_COMPUTE_FILE_NAME	"Hermite/3d.coeffs/3d.cube.order2/coeffs-I.compute.c"
#define COEFFS_DX_COMPUTE_FILE_NAME	"Hermite/3d.coeffs/3d.cube.order2/coeffs-dx.compute.c"
#define COEFFS_DY_COMPUTE_FILE_NAME	"Hermite/3d.coeffs/3d.cube.order2/coeffs-dy.compute.c"
#define COEFFS_DZ_COMPUTE_FILE_NAME	"Hermite/3d.coeffs/3d.cube.order2/coeffs-dz.compute.c"
#define COEFFS_DXX_COMPUTE_FILE_NAME	"Hermite/3d.coeffs/3d.cube.order2/coeffs-dxx.compute.c"
#define COEFFS_DXY_COMPUTE_FILE_NAME	"Hermite/3d.coeffs/3d.cube.order2/coeffs-dxy.compute.c"
#define COEFFS_DXZ_COMPUTE_FILE_NAME	"Hermite/3d.coeffs/3d.cube.order2/coeffs-dxz.compute.c"
#define COEFFS_DYY_COMPUTE_FILE_NAME	"Hermite/3d.coeffs/3d.cube.order2/coeffs-dyy.compute.c"
#define COEFFS_DYZ_COMPUTE_FILE_NAME	"Hermite/3d.coeffs/3d.cube.order2/coeffs-dyz.compute.c"
#define COEFFS_DZZ_COMPUTE_FILE_NAME	"Hermite/3d.coeffs/3d.cube.order2/coeffs-dzz.compute.c"
