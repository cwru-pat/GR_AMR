...
#define COEFFS_I_COMPUTE_FILE_NAME	"Lagrange-maximum-degree/2d.coeffs/2d.cube.order2.smooth0/coeffs-I.compute.c"
#define COEFFS_DX_COMPUTE_FILE_NAME	"Lagrange-maximum-degree/2d.coeffs/2d.cube.order2.smooth0/coeffs-dx.compute.c"
#define COEFFS_DY_COMPUTE_FILE_NAME	"Lagrange-maximum-degree/2d.coeffs/2d.cube.order2.smooth0/coeffs-dy.compute.c"
#define COEFFS_DXX_COMPUTE_FILE_NAME	"Lagrange-maximum-degree/2d.coeffs/2d.cube.order2.smooth0/coeffs-dxx.compute.c"
#define COEFFS_DXY_COMPUTE_FILE_NAME	"Lagrange-maximum-degree/2d.coeffs/2d.cube.order2.smooth0/coeffs-dxy.compute.c"
#define COEFFS_DYY_COMPUTE_FILE_NAME	"Lagrange-maximum-degree/2d.coeffs/2d.cube.order2.smooth0/coeffs-dyy.compute.c"
