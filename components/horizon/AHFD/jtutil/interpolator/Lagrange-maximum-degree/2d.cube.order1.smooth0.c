...
#define COEFFS_I_COMPUTE_FILE_NAME	"Lagrange-maximum-degree/2d.coeffs/2d.cube.order1.smooth0/coeffs-I.compute.c"
#define COEFFS_DX_COMPUTE_FILE_NAME	"Lagrange-maximum-degree/2d.coeffs/2d.cube.order1.smooth0/coeffs-dx.compute.c"
#define COEFFS_DY_COMPUTE_FILE_NAME	"Lagrange-maximum-degree/2d.coeffs/2d.cube.order1.smooth0/coeffs-dy.compute.c"
