...
/* function prototype */
#define FUNCTION_NAME			AEILocalInterp_U_LagTP_1cube_30
#include "../template.h"
...
#define COEFFS_I_COMPUTE_FILE_NAME	"Lagrange-tensor-product/1d.coeffs/1d.cube.order3.smooth0/coeffs-I.compute.c"
#define COEFFS_DX_COMPUTE_FILE_NAME	"Lagrange-tensor-product/1d.coeffs/1d.cube.order3.smooth0/coeffs-dx.compute.c"
#define COEFFS_DXX_COMPUTE_FILE_NAME	"Lagrange-tensor-product/1d.coeffs/1d.cube.order3.smooth0/coeffs-dxx.compute.c"
